...
//@NamedStoredProcedureQuery(name = "accCreation",
//procedureName = "account_creation", parameters = {
//@StoredProcedureParameter(mode = ParameterMode.IN, name = "account_id", type = Integer.class),
//@StoredProcedureParameter(mode = ParameterMode.IN, name = "account_type", type = String.class)})
@Entity
@Table(name = "account_details")
...
//        }
	...
	public boolean isOverdraftAvailed() {
		return overdraftAvailed;
	}

	public void setOverdraftAvailed(boolean overdraftAvailed) {
		this.overdraftAvailed = overdraftAvailed;
	}
