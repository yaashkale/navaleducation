...
public class AccountServiceImp implements AccountService {
    ...
    public List<Account> getAccountsByCustomerId(int searchCustomerId) {
        return accountrepository.findAccountsByCustomer_CustomerId(searchCustomerId);
    }
    ...
    public Account updateAccount(int accountId, Account accountDetails) {
        ...
        if (existingAccount != null) {
            ...
            existingAccount.setOverdraftAvailed(accountDetails.isOverdraftAvailed());
    ...
    @Override
    public void createAccount(int customerId, String accountType, boolean overdraftAvailed) {
        accountrepository.callAccountCreationProcedure(customerId, accountType, overdraftAvailed);
    }
}
